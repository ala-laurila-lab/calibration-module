classdef CalibrationSchema < io.mpa.Schema
    ...
    enumeration
        ...
        LINEARITY_MEASUREMENT([...
            ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('voltages') ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('voltageExponent') ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('meanCharge') ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('stdOfCharge') ...
        ...
        NDF_MEASUREMENT([...
            ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('powers') ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('powerExponent') ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('powerWithNdf') ...
            io.mpa.H5DataType.COMPOUND_DOUBLE_DATASET.map('powerWithNdfExponent') ...
            ])
