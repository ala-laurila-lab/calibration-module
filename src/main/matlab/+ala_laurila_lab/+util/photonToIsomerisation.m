function isomerization_rate_sum = photonToIsomerisation(power_spectrum, lambda, lambda_max, photoreceptor_collecting_area)
...
%   spectrum , photoreceptor collecting area and number of photons 
...
isomerization_rate = photons .*absorbance_spectrum * photoreceptor_collecting_area ;
